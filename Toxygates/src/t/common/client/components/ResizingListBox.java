...
/**
 * A list box that resizes itself vertically. This is needed for Internet Explorer to handle
 * vertically resizing lists correctly. All other web browsers would have handled the standard
 * ListBox fine on vertical resize.
 */
public class ResizingListBox extends ListBox implements RequiresResize {
  ...
  public ResizingListBox(int offset) {
    ...
    this.addStyleName("resizingListBox");
  }
