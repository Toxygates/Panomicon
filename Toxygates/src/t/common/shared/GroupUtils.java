...
public class GroupUtils {
	 ...
	 * @return
	 */
  public static <T extends Sample, G extends SampleGroup<T>> G findGroup(
      List<G> groups, String title) {
    for (G g : groups) {
	 ...
	 * @return
	 */
  public static <T extends Sample> SampleGroup<T> groupFor(
      List<? extends SampleGroup<T>> columns, String barcode) {
   ...
   * @return
   */
  public static <T extends Sample, G extends SampleGroup<T>> List <G> groupsFor(
      List<G> columns, String barcode) {
	...
	public static Set<String> collect(List<? extends SampleGroup<?>> columns, 
	    String parameter) {
  ...
  public static <T extends Sample> T sampleFor(
      List<? extends SampleGroup<T>> columns, String id) {
    for (SampleGroup<T> c : columns) {
      for (T t : c.getSamples()) {
        if (t.id().equals(id)) {
          return t;
