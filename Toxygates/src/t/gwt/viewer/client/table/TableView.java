...
import t.gwt.viewer.client.screen.groupdef.ColumnScreen;
...
import t.gwt.viewer.client.components.*;
import t.gwt.viewer.client.dialog.DialogPosition;
import t.gwt.viewer.client.rpc.MatrixServiceAsync;
import t.gwt.viewer.client.screen.data.DataScreen;
import t.gwt.viewer.client.screen.data.HeatmapViewer;
import t.gwt.viewer.client.screen.data.MirnaSourceDialog;
